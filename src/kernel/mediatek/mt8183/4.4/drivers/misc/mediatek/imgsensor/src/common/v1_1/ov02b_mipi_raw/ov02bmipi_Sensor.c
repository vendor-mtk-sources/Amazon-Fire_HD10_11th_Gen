...
static kal_uint16 ov02b_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	if (gain < BASEGAIN)
		reg_gain = BASEGAIN;
	else if (gain > OV02B_SENSOR_DGAIN_MAX)
		reg_gain = OV02B_SENSOR_DGAIN_MAX;
...
kal_uint16 addr_data_pair_init_ov02b[] = {
	0xfc, 0x01,
	0xfd, 0x00,
	0xfd, 0x00,
	0x24, 0x02,
...
kal_uint16 addr_data_pair_hs_video_ov02b[] = {
	0xfd, 0x01,
	0x02, 0x00,
	0x03, 0xc0,
	0x04, 0x01,
...
{
	LOG_INF("E\n");
	ov02b_table_write_cmos_sensor(
	    addr_data_pair_init_ov02b,
		sizeof(addr_data_pair_init_ov02b) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_DBG("E\n");
	ov02b_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov02b,
		sizeof(addr_data_pair_hs_video_ov02b) /
		sizeof(kal_uint16));
}
...
UINT32 OV02B_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
