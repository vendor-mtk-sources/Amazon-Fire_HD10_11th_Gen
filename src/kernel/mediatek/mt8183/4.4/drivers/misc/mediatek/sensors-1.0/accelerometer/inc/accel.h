...
#define ACC_PR_ERR(fmt, args...)	pr_err(ACC_TAG"%s %d : "fmt, __func__,\
						__LINE__, ##args)
#define ACC_LOG(fmt, args...)		pr_debug(ACC_TAG"%s %d : "fmt,\
						__func__, __LINE__, ##args)
#define ACC_VER(fmt, args...)		pr_debug(ACC_TAG"%s %d : "fmt,\
						__func__, __LINE__, ##args)
