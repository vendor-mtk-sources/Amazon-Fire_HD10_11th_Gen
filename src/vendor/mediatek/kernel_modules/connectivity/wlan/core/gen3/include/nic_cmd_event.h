...
typedef enum _ENUM_EVENT_ID_T {
	...
	EVENT_ID_GET_ANT_SWITCH_CAP = 0xFD,
...
typedef enum _ENUM_BEACON_TIMEOUT_TYPE_T {
	BEACON_TIMEOUT_HW_BEACON_LOST_NONADHOC = 0,
	BEACON_TIMEOUT_HW_BEACON_LOST_ADHOC,
	BEACON_TIMEOUT_HW_TSF_DRIF,
	BEACON_TIMEOUT_NULL_FRAME_THRESHOLD,
	BEACON_TIMEOUT_AGING_THRESHOLD,
	BEACON_TIMEOUT_BSSID_BEACON_PEIROD_NOT_ILLIGAL,
	BEACON_TIMEOUT_CONNECTION_FAIL,
	BEACON_TIMEOUT_ALLOCAT_NULL_PKT_FAILED_THRESHOLD,
	BEACON_TIMEOUT_NO_TX_DONE_EVENT,
	BEACON_TIMEOUT_UNSPECIF_REASON,
	BEACON_TIMEOUT_SET_CHIP,
	BEACON_TIMEOUT_KEEP_SCAN_AP_MISS_CHECK_FAILED,
	BEACON_TIMEOUT_KEEP_UNCHANGED_LOW_RSSI_CHECK_FAIL,
	BEACON_TIMEOUT_NULL_FRAME_LIFE_TIMEOUT,
