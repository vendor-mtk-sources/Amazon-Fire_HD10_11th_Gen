 ...
 *
 * Copyright 2015-2020 Amazon Technologies, Inc. All Rights Reserved.
 *
...
static int life_cycle_panic_notifier(struct notifier_block *nb,
				     unsigned long code, void *unused)
{
...
static struct notifier_block life_cycle_panic_nb = {
	.notifier_call = life_cycle_panic_notifier,
};
...
static int __init dev_sol_init(void)
{
	...
	/*regiter reboot and panic call chain*/
