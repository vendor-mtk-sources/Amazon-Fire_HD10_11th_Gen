...
#include "mtk_static_power_mt8183.h"
...
static const struct of_device_id g_gpufreq_of_match[] = {
	{ .compatible = "mediatek,mt8183-gpufreq" },
	{ /* sentinel */ }
};
...
static void __mt_gpufreq_clock_switch(unsigned int freq_new)
{
	...
	/* [MT8183] GPUPLL_CON1[24:26] is POST_DIVIDER
	 *    000 : /1
	 *    001 : /2
	 *    010 : /4
	 *    011 : /8
		...
		enum g_post_divider_power_enum post_divider_power)
{
	...
	/* [MT8183] dds is GPUPLL_CON1[21:0] */
...
static int __mt_gpufreq_pdrv_probe(struct platform_device *pdev)
{
	...
	if (g_segment_id == MT8183_SEGMENT_1) {
	...
	} else if (g_segment_id == MT8183_SEGMENT_2) {
	...
	} else if (g_segment_id == MT8183_SEGMENT_3) {
	...
	} else if (g_segment_id == MT8183_SEGMENT_4) {
