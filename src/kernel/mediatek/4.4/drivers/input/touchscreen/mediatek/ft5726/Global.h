...
/*
* -----------------------------------------------------------
* IC mapping table. Each one is 8 bit IC codes.
* High four representatives of the same series,
* The difference between the low four specific IC.
* -----------------------------------------------------------
*/
enum IC_Type {
	IC_FT5X36 = 0x10,
...
int GetPrivateProfileString(char *section, char *ItemName,
		char *defaultvalue, char *returnValue, int returnValue_size,
		char *IniFile);
