...
TRACE_EVENT(VPU__busyrate,
	TP_PROTO(int core0, int value0, int core1, int value1),
	TP_ARGS(core0, value0, core1, value1),
	TP_STRUCT__entry(
		__field(int, core0)
		__field(int, value0)
		__field(int, core1)
	...
	TP_fast_assign(
		__entry->core0 = core0;
		__entry->value0 = value0;
		__entry->core1 = core1;
		__entry->value1 = value1;
	),
	TP_printk("_id0=c%d, busyrate0=%d, _id1=c%d, busyrate1=%d", __entry->core0, __entry->value0, __entry->core1, __entry->value1)
);
