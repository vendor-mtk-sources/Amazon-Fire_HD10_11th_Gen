...
#define LM36274_OVP_MASK			(BIT(5) | BIT(6) | BIT(7))
#define LM36274_OVP_17V				0
#define LM36274_OVP_21V				(1 << LM36274_OVP_SHIFT)
#define LM36274_OVP_25V				(2 << LM36274_OVP_SHIFT)
#define LM36274_OVP_29V				(3 << LM36274_OVP_SHIFT)
#define LM36274_PWM_SHIFT			0
#define LM36274_PWM_MASK			BIT(0)
#define LM36274_PWM_DISABLE			(0 << LM36274_PWM_SHIFT)
#define LM36274_PWM_ENABLE			(1 << LM36274_PWM_SHIFT)
...
#define LM36274_REG_FLAGS			0x0F
#define LM36274_BL_OCP_MASK			BIT(0)
#define LM36274_BL_OVP_MASK			BIT(1)
#define LM36274_VNEG_SHORT_MASK			BIT(2)
#define LM36274_VPOS_SHORT_MASK			BIT(3)
#define LM36274_LCM_OVP_MASK			BIT(5)
#define LM36274_TSD_MASK			BIT(6)

#define LM36274_REG_OPTION_1			0x10
#define LM36274_HIGH_PWM_SHIFT			0
#define LM36274_HIGH_PWM_MASK			BIT(0)
#define LM36274_HIGH_PWM			(1 << LM36274_HIGH_PWM_SHIFT)

#define LM36274_REG_OPTION_2			0x11
#define LM36274_BOOST_CUR_LIMIT_SHIFT		0
#define LM36274_BOOST_CUR_LIMIT_MASK		(BIT(0) | BIT(1))
#define LM36274_BOOST_CUR_LIMIT_0_9_A		(0 << LM36274_BOOST_CUR_LIMIT_SHIFT)
#define LM36274_BOOST_CUR_LIMIT_1_2_A		(1 << LM36274_BOOST_CUR_LIMIT_SHIFT)
#define LM36274_BOOST_CUR_LIMIT_1_5_A		(2 << LM36274_BOOST_CUR_LIMIT_SHIFT)
#define LM36274_BOOST_CUR_LIMIT_1_8_A		(3 << LM36274_BOOST_CUR_LIMIT_SHIFT)
