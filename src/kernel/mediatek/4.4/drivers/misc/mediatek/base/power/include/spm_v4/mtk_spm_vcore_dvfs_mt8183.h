...
#ifndef __MTK_SPM_VCORE_DVFS_MT8183_H__
#define __MTK_SPM_VCORE_DVFS_MT8183_H__
...
extern int mtk_rgu_cfg_dvfsrc(int enable);

#endif /* __MTK_SPM_VCORE_DVFS_MT8183_H__ */
