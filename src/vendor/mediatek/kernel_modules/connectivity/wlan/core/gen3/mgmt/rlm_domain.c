...
static const UINT_16 g_u2CountryGroup11[] = {
	COUNTRY_CODE_JO, COUNTRY_CODE_PG, COUNTRY_CODE_WW
};
...
DOMAIN_INFO_ENTRY arSupportedRegDomains[] = {
	...
	,
	{
	 (PUINT_16) g_u2CountryGroup4, sizeof(g_u2CountryGroup4) / 2,
	 {
	  ...
	  {115, BAND_5G, CHNL_SPAN_20, 36, 4, FALSE}
	  ,			/* CH_SET_UNII_LOW_36_48 */
#if CFG_SUPPORT_DFS_CHANNEL /* fos_change begin */
	  {118, BAND_5G, CHNL_SPAN_20, 52, 4, TRUE}
	  ,			/* CH_SET_UNII_MID_52_64 */
	  {121, BAND_5G, CHNL_SPAN_20, 100, 11, TRUE}
	  ,			/* CH_SET_UNII_WW_100_140 */
...
static const UINT_16 g_u2CountryGroup1_Passive[] = {
	COUNTRY_CODE_US,
	COUNTRY_CODE_CA
};
static const UINT_16 g_u2CountryGroup2_Passive[] = {
	COUNTRY_CODE_DE,
	COUNTRY_CODE_IT,
	COUNTRY_CODE_ES,
	COUNTRY_CODE_GB,
...
static const UINT_16 g_u2CountryGroup3_Passive[] = {
	COUNTRY_CODE_JP
};
static const UINT_16 g_u2CountryGroup4_Passive[] = {
	COUNTRY_CODE_AU,
	COUNTRY_CODE_NZ
};
#endif /* fos_change end */
...
DOMAIN_INFO_ENTRY arSupportedRegDomains_Passive[] = {
 ...
 #if CFG_SUPPORT_DFS_CHANNEL
	{
	 (PUINT_16) g_u2CountryGroup1_Passive, sizeof(g_u2CountryGroup1_Passive) / 2,
	 {
	  {81, BAND_2G4, CHNL_SPAN_5, 1, 0, 0}
	  ,			/* CH_SET_2G4_NA */
	  {82, BAND_2G4, CHNL_SPAN_5, 12, 2, 0}
	 ...
	 {
	  (PUINT_16) g_u2CountryGroup2_Passive, sizeof(g_u2CountryGroup2_Passive) / 2,
	  {
	   {81, BAND_2G4, CHNL_SPAN_5, 1, 0, 0}
	   ,		 /* CH_SET_2G4_NA */
	   {82, BAND_2G4, CHNL_SPAN_5, 12, 0, 0}
	   ,
	   {115, BAND_5G, CHNL_SPAN_20, 36, 0, 0}
	   ,		 /* CH_SET_UNII_LOW */
	   {118, BAND_5G, CHNL_SPAN_20, 52, 4, 0}
	 ...
	 {
	  (PUINT_16) g_u2CountryGroup3_Passive, sizeof(g_u2CountryGroup3_Passive) / 2,
	  {
	   {81, BAND_2G4, CHNL_SPAN_5, 1, 0, 0}
	   ,		 /* CH_SET_2G4_NA */
	   {82, BAND_2G4, CHNL_SPAN_5, 12, 0, 0}
	  ...
	  {
	   (PUINT_16) g_u2CountryGroup4_Passive, sizeof(g_u2CountryGroup4_Passive) / 2,
	   {
		{81, BAND_2G4, CHNL_SPAN_5, 1, 0, 0}
		,		  /* CH_SET_2G4_NA */
		{82, BAND_2G4, CHNL_SPAN_5, 12, 0, 0}
		...
		{118, BAND_5G, CHNL_SPAN_20, 52, 4, 0}
		,		  /* CH_SET_UNII_MID_52_64 */
		{121, BAND_5G, CHNL_SPAN_20, 100, 5, 0}
		,		  /* CH_SET_UNII_WW_100_140 */
		{121, BAND_5G, CHNL_SPAN_20, 132, 4, 0}
		,
		{125, BAND_5G, CHNL_SPAN_20, 149, 0, 0}
		,		  /* CH_SET_UNII_UPPER_NA */
		}
...
TX_PWR_REGION_INFO_ENTRY arSupportedTxPwrRegion[] = {
	...
	{(PUINT_16) g_u2TxPwrRegion5, sizeof(g_u2TxPwrRegion5) / 2,
	 REGION_CODE_FCC}
	,
	{(PUINT_16) g_u2TxPwrRegion6, sizeof(g_u2TxPwrRegion6) / 2,
	 REGION_CODE_CA}
	,
#else
	{(PUINT_16) g_u2TxPwrRegion1, sizeof(g_u2TxPwrRegion1) / 2,
	 REGION_CODE_FCC}
	,
#endif
	{(PUINT_16) g_u2TxPwrRegion2, sizeof(g_u2TxPwrRegion2) / 2,
	 REGION_CODE_CE}
	,
	...
	for (i = 0; i < sizeof(g_rRlmPowerLimitConfiguration) / sizeof(COUNTRY_POWER_LIMIT_TABLE_CONFIGURATION); i++) {
		...
		if (u2CountryCodeTable == COUNTRY_CODE_NULL) {
			...
			break;	/*end of configuration table */
			    ...
			    || (u2CountryCodeTable == rlmConvertCountry2Region(prAdapter,
				& (prCmd->u2CountryCode)))) && (fgChannelValid == TRUE)) {
#else
		} else if ((u2CountryCodeTable == prCmd->u2CountryCode)
			   && (fgChannelValid == TRUE)) {
#endif
