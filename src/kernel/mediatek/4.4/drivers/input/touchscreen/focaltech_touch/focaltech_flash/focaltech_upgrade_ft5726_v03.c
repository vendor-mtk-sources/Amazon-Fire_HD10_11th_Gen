...
static int fts_ft5726_flag(u8 *buf)
{
	u8 app_flag[6] = {0x57,0xA8,0x26,0xD9,0x03,0xFC};
	if(!(memcmp(app_flag,buf+0x10E,6)))
		return 0;
	return -EINVAL;
}

static int fts_ft5726_v03_upgrade(u8 *buf, u32 len)
{
    int ret = 0;
    u32 start_addr = 0;
    u8 cmd[4] = { 0 };
    ...
    /* write app */
    start_addr = upgrade_func_ft5726_v03.appoff;
...
struct upgrade_func upgrade_func_ft5726_v03 = {
    .ctype = {0x86},
    .fwveroff = 0x10A,
    .fwcfgoff = 0x103B0,
    .appoff = 0x0000,
    ...
    .hid_supported = true,
    .upgrade = fts_ft5726_v03_upgrade,
};
