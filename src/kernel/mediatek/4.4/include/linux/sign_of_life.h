...
typedef enum {
	...
	THERMAL_SHUTDOWN_REASON_CPVS    = 0x30B,
	THERMAL_SHUTDOWN_REASON_MOTOR	= 0x30C,
	THERMAL_SHUTDOWN_REASON_MOTOR_PCB	= 0x30D,
	THERMAL_SHUTDOWN_REASON_MLB	= 0x30E,
	THERMAL_SHUTDOWN_REASON_DISP	= 0x30F,
	THERMAL_SHUTDOWN_REASON_UPPER_DRUM	= 0x310,
	THERMAL_SHUTDOWN_REASON_DRUM_BASE	= 0x311,
	THERMAL_SHUTDOWN_REASON_DUAL_SOC	= 0x312,
