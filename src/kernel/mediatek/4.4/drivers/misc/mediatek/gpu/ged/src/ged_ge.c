...
int ged_bridge_ge_get(
	...
	size_t output_package_size)
{
	/* in gpu_ext/ged/lib/ged_ge.cpp. ged_ge_get()
	 * iOutSize use the sizeof(GED_BRIDGE_OUT_GE_GET)
	 * as header size.
	 */
	size_t header_size = sizeof(GED_BRIDGE_OUT_GE_GET);
...
int ged_bridge_ge_set(
	...
	size_t input_package_size)
{

	size_t header_size = sizeof(GED_BRIDGE_IN_GE_SET);
