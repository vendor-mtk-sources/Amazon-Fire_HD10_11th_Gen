 ...
 */
#define RTC_NEW_SPARE2_THERMAL_SHUTDOWN_BATTERY	(1U << 8)
#define RTC_NEW_SPARE2_THERMAL_SHUTDOWN_PMIC	(1U << 9)
#define RTC_NEW_SPARE2_THERMAL_SHUTDOWN_SOC	(1U << 10)
#define RTC_NEW_SPARE2_THERMAL_SHUTDOWN_WIFI	(1U << 11)
#define RTC_NEW_SPARE2_THERMAL_SHUTDOWN_BTS	(1U << 12)
#define RTC_NEW_SPARE2_THERMAL_SHUTDOWN_PCB	(1U << 13)
...
static int (mtk_read_thermal_shutdown_reason)(life_cycle_reason_t *thermal_shutdown_reason)
{
	...
	printk(KERN_ERR"%s: thermal shutdown reason 0x%x\n", __func__, rtc_thermal_shutdown_reason & RTC_NEW_SPARE2_THERMAL_SHUTDOWN_MASK);
	if (rtc_thermal_shutdown_reason & RTC_NEW_SPARE2_THERMAL_SHUTDOWN_BATTERY)
		*thermal_shutdown_reason = THERMAL_SHUTDOWN_REASON_BATTERY;
	else if (rtc_thermal_shutdown_reason & RTC_NEW_SPARE2_THERMAL_SHUTDOWN_PMIC)
		*thermal_shutdown_reason = THERMAL_SHUTDOWN_REASON_PMIC;
	else if (rtc_thermal_shutdown_reason & RTC_NEW_SPARE2_THERMAL_SHUTDOWN_SOC)
		*thermal_shutdown_reason = THERMAL_SHUTDOWN_REASON_SOC;
	else if (rtc_thermal_shutdown_reason & RTC_NEW_SPARE2_THERMAL_SHUTDOWN_WIFI)
		*thermal_shutdown_reason = THERMAL_SHUTDOWN_REASON_WIFI;
	else if (rtc_thermal_shutdown_reason & RTC_NEW_SPARE2_THERMAL_SHUTDOWN_PCB)
		*thermal_shutdown_reason = THERMAL_SHUTDOWN_REASON_PCB;
	else if (rtc_thermal_shutdown_reason & RTC_NEW_SPARE2_THERMAL_SHUTDOWN_BTS)
...
static int (mtk_write_thermal_shutdown_reason)(life_cycle_reason_t thermal_shutdown_reason)
{
	...
	if (thermal_shutdown_reason == THERMAL_SHUTDOWN_REASON_BATTERY)
		rtc_thermal_shutdown_reason = rtc_thermal_shutdown_reason | RTC_NEW_SPARE2_THERMAL_SHUTDOWN_BATTERY;
	else if (thermal_shutdown_reason == THERMAL_SHUTDOWN_REASON_PMIC)
		rtc_thermal_shutdown_reason = rtc_thermal_shutdown_reason | RTC_NEW_SPARE2_THERMAL_SHUTDOWN_PMIC;
	else if (thermal_shutdown_reason == THERMAL_SHUTDOWN_REASON_SOC)
		rtc_thermal_shutdown_reason = rtc_thermal_shutdown_reason | RTC_NEW_SPARE2_THERMAL_SHUTDOWN_SOC;
	else if (thermal_shutdown_reason == THERMAL_SHUTDOWN_REASON_WIFI)
		rtc_thermal_shutdown_reason = rtc_thermal_shutdown_reason | RTC_NEW_SPARE2_THERMAL_SHUTDOWN_WIFI;
	else if (thermal_shutdown_reason == THERMAL_SHUTDOWN_REASON_PCB)
		rtc_thermal_shutdown_reason = rtc_thermal_shutdown_reason | RTC_NEW_SPARE2_THERMAL_SHUTDOWN_PCB;
	else if (thermal_shutdown_reason == THERMAL_SHUTDOWN_REASON_BTS)
		rtc_thermal_shutdown_reason = rtc_thermal_shutdown_reason | RTC_NEW_SPARE2_THERMAL_SHUTDOWN_BTS;
