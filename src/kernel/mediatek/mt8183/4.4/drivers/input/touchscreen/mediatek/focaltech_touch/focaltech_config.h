...
/*
 * Enable the unused gesture key
 * default: disable
 */

#define FTS_DEFAULT_GESTURE_KEY_EN              0
 ...
 */
#define FTS_MODULE_ID                          0x76E4
#define FTS_MODULE2_ID                         0x70E4
#define FTS_MODULE3_ID                         0x76AA
#define FTS_MODULE4_ID                         0xC43E
...
/*
 * if FTS_GET_MODULE_NUM >= 5, fw corrsponding with FTS_VENDOR_ID6
 * define your own fw_file, the sample one is invalid
 */
#define FTS_UPGRADE_FW5_FILE                     "include/firmware/fw_sample.i"

/*
 * if FTS_GET_MODULE_NUM >= 6, fw corrsponding with FTS_VENDOR_ID6
 * define your own fw_file, the sample one is invalid
 */
#define FTS_UPGRADE_FW6_FILE                     "include/firmware/fw_sample.i"

/*
 * if FTS_GET_MODULE_NUM >= 7, fw corrsponding with FTS_VENDOR_ID7
 * define your own fw_file, the sample one is invalid
 */
