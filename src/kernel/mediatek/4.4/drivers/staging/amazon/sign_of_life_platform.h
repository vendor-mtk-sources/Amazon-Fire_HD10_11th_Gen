...
static struct sign_of_life_reason_data lcr_data[] = {
	...
	/* Device shutdown due to overheated Motor */
	{THERMAL_SHUTDOWN_REASON_MOTOR, "Motor Overheated Thermal Shutdown", "LCR_abnormal"},
	/* Device shutdown due to overheated Motor PCB */
	{THERMAL_SHUTDOWN_REASON_MOTOR_PCB, "Motor PCB Overheated Thermal Shutdown", "LCR_abnormal"},
	/* Device shutdown due to overheated MLB */
	{THERMAL_SHUTDOWN_REASON_MLB, "MLB Overheated Thermal Shutdown", "LCR_abnormal"},
	/* Device shutdown due to overheated Display */
	{THERMAL_SHUTDOWN_REASON_DISP, "Display Overheated Thermal Shutdown", "LCR_abnormal"},
	/* Device shutdown due to overheated Up drum */
	{THERMAL_SHUTDOWN_REASON_UPPER_DRUM, "Upper Drum Overheated Thermal Shutdown", "LCR_abnormal"},
	/* Device shutdown due to overheated Drum base */
	{THERMAL_SHUTDOWN_REASON_DRUM_BASE, "Drum Base Overheated Thermal Shutdown", "LCR_abnormal"},
	/* Device shutdown due to overheated CPU virual sensor */
	{THERMAL_SHUTDOWN_REASON_CPVS, "CPU Virtual Sensor Overheated Thermal Shutdown", "LCR_abnormal"},
	/* Device shutdown due to overheated partner SoC */
	{THERMAL_SHUTDOWN_REASON_DUAL_SOC, "Partner SoC Overheated Thermal Shutdown", "LCR_abnormal"},
	/* Device shutdown due to overheated skin display frame */
	{THERMAL_SHUTDOWN_REASON_SVS, "Skin Display Frame Overheated Thermal Shutdown", "LCR_abnormal"},
