...
#define GTP_FW_UPDATE_COMPLETE 1
#define GTP_FW_UPDATE_INCOMPLETE 0

#ifdef GTP_CHECK_LCD_ID
#define GTP_LCD_ID_0_GPIO 18
#define GTP_LCD_ID_1_GPIO 19

#define GTP_LCD_INX 0
#define GTP_LCD_BOE 1
#define GTP_LCD_KD 2
#define GTP_LCD_UNKNOWN 3

#define GTP_GPIO_CHECK_LOOP 15
#define GTP_GPIO_CHECK_COUNT 5
#endif /*GTP_CHECK_LCD_ID*/

#define GTP_TP_TG_KDX 0
#define GTP_TP_TG_RIJIU 1
#define GTP_TP_LENS_RIJIU 2
#define GTP_TP_LENS_KDX 3
#define GTP_TP_LENS_RIJIU_125um 4
#define GTP_TP_LENS_RIJIU_150um 5

/****************************TP Dynamic Log***********************************/
#define TP_LOG_TAG "goodix"
...
#define GTP_RST_PORT    322	/* EXYNOS4_GPX2(0) */
#define GTP_INT_PORT    321	/* EXYNOS4_GPX2(1) */
...
#define GTP_DEFAULT_MAX_X	 1200	/* default coordinate max values */
#define GTP_DEFAULT_MAX_Y	 1920
#define GTP_DEFAULT_MAX_WIDTH	 1024
#define GTP_DEFAULT_MAX_PRESSURE 1024
#define GTP_DEFAULT_INT_TRIGGER	 2	/* 1 rising, 2 falling */
...
extern int gtp_reset_guitar(struct i2c_client *client, s32 ms);
...
extern int gup_update_config(struct i2c_client *client);
