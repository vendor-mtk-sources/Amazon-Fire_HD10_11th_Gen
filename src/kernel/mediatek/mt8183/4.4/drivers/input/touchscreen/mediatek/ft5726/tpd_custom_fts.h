...
/* gesture wakeup*/
extern int g_fts_gesture_wakeup_delayed; /*-1:no update, 0:disable, 1: enable */
extern int g_fts_slide_wakeup;
extern struct mutex g_fts_gesture_lock;
extern bool focal_suspend_flag;
