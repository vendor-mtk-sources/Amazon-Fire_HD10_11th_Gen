...
#define MT6370_RAMP_MASK			(0xF0)

#define MT6370_PWM_HYS_EN_MASK		(0x04)
#define MT6370_PWM_HYS_VAL_MASK		(0x03)
#define MT6370_PWM_HYS_EN_SHIFT		(2)
#define MT6370_PWM_HYS_VAL_SHIFT	(0)
#endif
