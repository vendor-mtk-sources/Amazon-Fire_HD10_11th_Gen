...
static void hx83102e_chip_init(void)
{
	...
	(*kp_IC_CHECKSUM) = HX_TP_BIN_CHECKSUM_CRC;
	/*Himax: Set FW and CFG Flash Address*/
	(*kp_FW_VER_MAJ_FLASH_ADDR) = 70661;  /*0x011405*/
	(*kp_FW_VER_MAJ_FLASH_LENG) = 1;
	(*kp_FW_VER_MIN_FLASH_ADDR) = 70662;  /*0x011406*/
	(*kp_FW_VER_MIN_FLASH_LENG) = 1;
	(*kp_CFG_VER_MAJ_FLASH_ADDR) = 70912;  /*0x011500*/
	(*kp_CFG_VER_MAJ_FLASH_LENG) = 1;
	(*kp_CFG_VER_MIN_FLASH_ADDR) = 70913;  /*0x011501*/
	(*kp_CFG_VER_MIN_FLASH_LENG) = 1;
	(*kp_CID_VER_MAJ_FLASH_ADDR) = 70658;  /*0x011402*/
	(*kp_CID_VER_MAJ_FLASH_LENG) = 1;
	(*kp_CID_VER_MIN_FLASH_ADDR) = 70659;  /*0x011403*/
	(*kp_CID_VER_MIN_FLASH_LENG) = 1;
