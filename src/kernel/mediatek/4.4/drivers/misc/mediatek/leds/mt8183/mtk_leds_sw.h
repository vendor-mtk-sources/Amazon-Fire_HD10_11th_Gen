...
#define MTK_LED_CUST_BRI_TABLE_ENTRY_SIZE 3
#define MTK_LED_CUST_BRI_TABLE_ENTRY_INDEX_BRI 0
#define MTK_LED_CUST_BRI_TABLE_ENTRY_INDEX_SLOP 1
#define MTK_LED_CUST_BRI_TABLE_ENTRY_INDEX_INTERCEPT 2
 ...
 * cust_bri_table: customized brightness convert table
 * ncust_table: cust_bri_table triplet number
 */
 ...
 * last_level: brightness level before fb event
 * fb_notifier: fb notifier
 */
