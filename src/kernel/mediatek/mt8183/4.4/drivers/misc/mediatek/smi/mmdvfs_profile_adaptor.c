...
#include "mmdvfs_config_mt8183.h"
...
#elif defined(SMI_SYL)
struct mmdvfs_step_util mmdvfs_step_util_obj_mt8183 = {
	{0},
	MMDVFS_SCEN_COUNT,
	{0},
	MT8183_MMDVFS_OPP_MAX,
	mt8183_mmdvfs_legacy_step_to_opp,
	MMDVFS_VOLTAGE_COUNT,
	mt8183_mmdvfs_mmclk_opp_to_legacy_mmclk_step,
	MT8183_MMDVFS_OPP_MAX,
	MMDVFS_FINE_STEP_OPP0,
	mmdvfs_step_util_init,
	mmdvfs_get_legacy_mmclk_step_from_mmclk_opp,
...
#elif defined(SMI_SYL)
struct mmdvfs_adaptor mmdvfs_adaptor_obj_mt8183 = {
	KIR_MM,
	0, 0, 0,
	mt8183_mmdvfs_clk_sources_setting, MT8183_MMDVFS_CLK_SOURCE_NUM,
	mt8183_mmdvfs_clk_hw_map_setting, MMDVFS_CLK_MUX_NUM,
	mt8183_step_profile, MT8183_MMDVFS_OPP_MAX,
	MT8183_MMDVFS_SMI_USER_CONTROL_SCEN_MASK,
	mmdvfs_profile_dump,
	mmdvfs_single_hw_configuration_dump,
	mmdvfs_hw_configuration_dump,
	mmdvfs_determine_step,
...
struct mmdvfs_adaptor mmdvfs_adaptor_obj_mt8183_3600 = {
	KIR_MM,
	0, 0, 0,
	mt8183_mmdvfs_clk_sources_setting, MT8183_MMDVFS_CLK_SOURCE_NUM,
	mt8183_mmdvfs_clk_hw_map_setting, MMDVFS_CLK_MUX_NUM,
	mt8183_step_profile_3600, MT8183_MMDVFS_OPP_MAX,
	MT8183_MMDVFS_SMI_USER_CONTROL_SCEN_MASK,
	mmdvfs_profile_dump,
	mmdvfs_single_hw_configuration_dump,
	mmdvfs_hw_configuration_dump,
...
struct mmdvfs_adaptor mmdvfs_adaptor_obj_mt8183_lp3 = {
	KIR_MM,
	0, 0, 0,
	mt8183_mmdvfs_clk_sources_setting, MT8183_MMDVFS_CLK_SOURCE_NUM,
	mt8183_mmdvfs_clk_hw_map_setting, MMDVFS_CLK_MUX_NUM,
	mt8183_step_profile_lp3, MT8183_MMDVFS_OPP_MAX,
	MT8183_MMDVFS_SMI_USER_CONTROL_SCEN_MASK,
	mmdvfs_profile_dump,
	mmdvfs_single_hw_configuration_dump,
	mmdvfs_hw_configuration_dump,
...
#elif defined(SMI_SYL)
struct mmdvfs_thresholds_dvfs_handler mmdvfs_thresholds_dvfs_handler_obj_mt8183 = {
	mt8183_mmdvfs_threshold_settings,
	MMDVFS_PM_QOS_SUB_SYS_NUM,
	get_step_by_threshold
};
struct mmdvfs_thresholds_dvfs_handler mmdvfs_thresholds_dvfs_handler_obj_mt8183_3600 = {
	mt8183_mmdvfs_threshold_settings_3600,
	MMDVFS_PM_QOS_SUB_SYS_NUM,
	get_step_by_threshold
};
...
void mmdvfs_config_util_init(void)
{
	...
	case MMDVFS_PROFILE_SYL:
#if defined(SMI_SYL)
		g_mmdvfs_thresholds_dvfs_handler = &mmdvfs_thresholds_dvfs_handler_obj_mt8183;
#if defined(USE_DDR_TYPE)
		if (get_dram_type() == TYPE_LPDDR3) {
			g_mmdvfs_adaptor = &mmdvfs_adaptor_obj_mt8183_lp3;
			cam_sensor_threshold = 480000000;
			disp_hrt_decrease_level1 = 150;
			disp_hrt_decrease_default = 0;
			MMDVFSMSG("g_mmdvfs_step_util init with lp3\n");
		} else if (dram_steps_freq(0) == 3600) {
			g_mmdvfs_adaptor = &mmdvfs_adaptor_obj_mt8183_3600;
			g_mmdvfs_thresholds_dvfs_handler = &mmdvfs_thresholds_dvfs_handler_obj_mt8183_3600;
			legacy_to_qos_step[MMDVFS_FINE_STEP_OPP1].qos_step = 0;
			MMDVFSMSG("g_mmdvfs_step_util init with lp4 2-ch (3600)\n");
		} else{
			g_mmdvfs_adaptor = &mmdvfs_adaptor_obj_mt8183;
			MMDVFSMSG("g_mmdvfs_step_util init with lp4 2-ch\n");
		}
#else
		g_mmdvfs_adaptor = &mmdvfs_adaptor_obj_mt8183;
		MMDVFSMSG("g_mmdvfs_step_util init with lp4 2-ch\n");
#endif
		g_mmdvfs_step_util = &mmdvfs_step_util_obj_mt8183;
#endif
		break;
