...
struct charger_ops {
	...
	int (*get_vbus_adc)(struct charger_device *, u32 *vbus);
	int (*get_ts_bat_adc)(struct charger_device *dev, u32 *ts);
...
extern int charger_dev_get_vbus(struct charger_device *charger_dev, u32 *vbus);
extern int charger_dev_get_ts_bat(struct charger_device *charger_dev, u32 *ts);
