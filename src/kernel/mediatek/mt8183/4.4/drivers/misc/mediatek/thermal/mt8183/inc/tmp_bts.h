...
#define BTS3_RAP_PULL_UP_R			390000		/* 390K,pull up resister */
#define BTS3_TAP_OVER_CRITICAL_LOW		4397119		/* base on 100K NTC temp default value -40 deg */
#define BTS3_RAP_PULL_UP_VOLTAGE		1800		/* 1.8V ,pull up voltage */
#define BTS3_RAP_NTC_TABLE			7		/* default is NCP15WF104F03RC(100K) */
#define BTS3_RAP_ADC_CHANNEL			AUX_IN3_NTC	/* default is 3 */
