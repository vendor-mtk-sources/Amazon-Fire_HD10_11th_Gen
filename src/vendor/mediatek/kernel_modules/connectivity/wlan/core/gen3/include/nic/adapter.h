...
/*#endif*/
	...
	int total_beacon_timeout_count;
	int beacon_timeout_count[BEACON_TIMEOUT_TYPE_NUM];
	int total_tx_done_fail_count;
	int tx_done_fail_count[TX_RESULT_NUM];
	int total_deauth_rx_count;
	int deauth_rx_count[REASON_CODE_BEACON_TIMEOUT + 1];
...
#define SUSPEND_FLAG_FOR_APP_TRX_STAT	    (2) /* CFG_SUPPORT_WIFI_POWER_DEBUG */
