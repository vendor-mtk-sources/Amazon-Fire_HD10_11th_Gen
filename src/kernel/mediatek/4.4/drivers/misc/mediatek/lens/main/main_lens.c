...
static struct stAF_DrvList g_stAF_DrvList[MAX_NUM_OF_LENS] = {
	...
	{1, AFDRV_BU64982AF, bu64982af_SetI2Cclient, bu64982af_Ioctl, bu64982af_Release, NULL},
	{1,
...
void AF_PowerDown(void)
{
	if (g_pstAF_I2Cclient != NULL) {
		...
		#if defined(CONFIG_MACH_MT6739) || defined(CONFIG_MACH_MT8183) || defined(CONFIG_MACH_MT6775)
