...
#if HX_MULT_BIN
#define CID_TG_BOE			0x18
#define CID_KD_INX			0x1A
...
struct upgrade_module {
	...
	char fw_name[MAX_MODULE_NAME_LEN];
	char csv_name[MAX_MODULE_NAME_LEN];
};
extern struct upgrade_module himax_module_list[];
