...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence[] = {
#if defined(GC2375_MIPI_RAW)
	{
	 SENSOR_DRVNAME_GC2375_MIPI_RAW,
	 {
	  ...
	  {PDN, Vol_Low, 1, Vol_High},
	  {RST, Vol_High, 2, Vol_Low},
	  {PDN, Vol_Low, 1, Vol_High}
	  },
	 },
#endif
#if defined(GC2375FRONT_MIPI_RAW)
	{
	 SENSOR_DRVNAME_GC2375FRONT_MIPI_RAW,
	 {
	  {PDN, Vol_High, 0, Vol_High},
	  {RST, Vol_Low, 0, Vol_Low},
	  {DOVDD, Vol_1800, 1, Vol_Low},
...
#endif
#if defined(GC2375SEC_MIPI_RAW)
	{
	 SENSOR_DRVNAME_GC2375SEC_MIPI_RAW,
	 {
	  {PDN, Vol_High, 0, Vol_High},
	  {RST, Vol_Low, 0, Vol_Low},
	  {DOVDD, Vol_1800, 1, Vol_Low},
...
#endif
#if defined(GC2375FRONTSEC_MIPI_RAW)
	{
	 SENSOR_DRVNAME_GC2375FRONTSEC_MIPI_RAW,
	 {
	  {PDN, Vol_High, 0, Vol_High},
	  {RST, Vol_Low, 0, Vol_Low},
	  {DOVDD, Vol_1800, 1, Vol_Low},
