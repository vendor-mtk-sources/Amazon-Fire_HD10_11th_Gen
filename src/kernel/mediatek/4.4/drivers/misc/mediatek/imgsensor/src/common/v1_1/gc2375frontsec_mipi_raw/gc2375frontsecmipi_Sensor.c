...
#include "gc2375frontsecmipi_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "GC2375frontsec_camera_sensor"
#define LOG_1 LOG_INF("GC2375FRONTSEC,MIPI 1LANE\n")
/******************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC2375FRONTSEC_SENSOR_ID,	/* record sensor id defined in Kd_imgsensor.h */
	...
	.i2c_addr_table = {0x2e, 0xff}, /* record sensor support all write id addr, only 4must end with 0xff */
};
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if ((iReg >= ANALOG_GAIN_1) && (iReg < ANALOG_GAIN_2)) {
		...
		LOG_INF("GC2375FRONTMIPI analogic gain 1x, GC2375FRONTMIPI add pregain = %d\n", temp);
	}
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("GC2375FRONTMIPI analogic gain 1.43x , GC2375FRONTMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("GC2375FRONTMIPI analogic gain 2x , GC2375FRONTMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("GC2375FRONTMIPI analogic gain 2.84x , GC2375FRONTMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("GC2375FRONTMIPI analogic gain 3.97x , GC2375FRONTMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("GC2375FRONTMIPI analogic gain 5.68x , GC2375FRONTMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("GC2375FRONTMIPI analogic gain 8.14x , GC2375FRONTMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("GC2375FRONTMIPI analogic gain 11.34x , GC2375FRONTMIPI add pregain = %d\n", temp);
	}
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("GC2375FRONTMIPI analogic gain 16.23x , GC2375FRONTMIPI add pregain = %d\n", temp);
	}
	return gain;
...
UINT32 GC2375FRONTSEC_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}			/*    GC2375FRONT_MIPI_RAW_SensorInit    */
