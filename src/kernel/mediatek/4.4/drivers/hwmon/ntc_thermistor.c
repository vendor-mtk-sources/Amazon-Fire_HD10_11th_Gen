...
static const struct platform_device_id ntc_thermistor_id[] = {
	...
	{ "ncu18xh103f60rb", TYPE_NCU18XH103F60RB },
	{ },
};
...
static const struct ntc_compensation ncu18xh103f60rb[] = {
...
static const struct of_device_id ntc_match[] = {
	...
	{ .compatible = "murata,ncu18xh103f60rb",
...
static int ntc_thermistor_probe(struct platform_device *pdev)
{
	...
	case TYPE_NCPXXWF104:
		...
		break;
	case TYPE_NCU18XH103F60RB:
		data->comp = ncu18xh103f60rb;
		data->n_comp = ARRAY_SIZE(ncu18xh103f60rb);
		break;
	default:
