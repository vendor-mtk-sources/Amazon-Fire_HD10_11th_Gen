...
#define VID_HX_KD_INX     0x6		/* KD, using HX83102-p IC, add from EVT */
...
extern void ft8201_share_powerpin_on(void);
extern void ft8201_share_powerpin_off(void);
extern void ft8201ab_share_powerpin_on(void);
extern void ft8201ab_share_powerpin_off(void);
extern int ft8201_share_request_powerpin_resource(struct device *dev);
extern int ft8201ab_share_request_powerpin_resource(struct device *dev);
extern void ft8201_share_tp_resetpin_high(void);
extern void ft8201_share_tp_resetpin_low(void);
extern void ft8201ab_share_tp_resetpin_high(void);
extern void ft8201ab_share_tp_resetpin_low(void);
extern unsigned int ft8201_incell_compare_id(void);
extern unsigned int ft8201ab_incell_compare_id(void);
extern void tpd_suspend(struct device *dev);
extern void tpd_resume(struct device *dev);
