...
#include "gc2375frontmipi_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "GC2375front_camera_sensor"
#define LOG_1 LOG_INF("GC2375FRONT,MIPI 1LANE\n")
/******************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC2375FRONT_SENSOR_ID,	/* record sensor id defined in Kd_imgsensor.h */
...
UINT32 GC2375FRONT_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
