 ...
 *		bit 13: Skipped the bit since it's for RTC_WARMBOOT_BY_KERNEL_WATCHDOG
 *		at abc123 which wrote by ATF, Trona uses the same Kernel / trustzone
 *		with abc123 but uses cmdline to indicate the boot reason for reducing
 *		the porting effort.
 *		bit 14 - bit 15: life cycle boot reason
 */
#define RTC_BOOT_MASK			0xC000
#define RTC_BOOT_SHIFT			14
