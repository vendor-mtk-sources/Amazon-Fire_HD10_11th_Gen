...
static struct proc_dir_entry *NVT_proc_tp_fw_version_entry;
...
{
	seq_printf(m, "fw_ver=%02X, pid=%04X\n", ts->fw_ver, ts->nvt_pid);
	return 0;
}
...
int32_t nvt_extra_proc_init(void)
{
	...
	NVT_proc_tp_fw_version_entry = proc_create(TP_FW_VERSION, 0444, NULL, &tp_fw_version_fops);
	if (NVT_proc_tp_fw_version_entry == NULL) {
