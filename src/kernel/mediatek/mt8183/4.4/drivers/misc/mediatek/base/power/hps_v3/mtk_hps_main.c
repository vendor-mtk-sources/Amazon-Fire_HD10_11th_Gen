...
#if defined(CONFIG_MACH_MT8183) || defined(CONFIG_MACH_MT6775)
...
static int hps_probe(struct platform_device *pdev)
{
#if defined(CONFIG_MACH_MT6799) || defined(CONFIG_MACH_MT8183) || defined(CONFIG_MACH_MT6775)
	int ret;
#endif
...
#endif /* CONFIG_MACH_MT8183 || CONFIG_MACH_MT6775 */
