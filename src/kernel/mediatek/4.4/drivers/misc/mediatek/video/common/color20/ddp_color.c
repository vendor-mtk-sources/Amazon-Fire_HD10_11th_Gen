...
#include "mt-plat/mtk_chip.h"
	...
	defined(CONFIG_MACH_MT6775) || defined(CONFIG_MACH_MT6739) || defined(CONFIG_MACH_MT8183)
...
static unsigned int color_is_reg_addr_valid(unsigned long addr)
{
	...
	defined(CONFIG_MACH_MT6763) || defined(CONFIG_MACH_MT6739) || defined(CONFIG_MACH_MT8183)
...
static int _color_clock_on(enum DISP_MODULE_ENUM module, void *cmq_handle)
{
	...
	defined(CONFIG_MACH_MT6739) || defined(CONFIG_MACH_MT8183)
